...
namespace ntrex
{
  ...
  MwAhrsRosDriver::MwAhrsRosDriver(char *port, int baud_rat, int sel, uint8_t data, uint32_t ms) : Node("MW_AHRS_ROS2")
  {
    int res = MW_AHRS_Serial_Connect(port, baud_rat, sel, data, ms);
